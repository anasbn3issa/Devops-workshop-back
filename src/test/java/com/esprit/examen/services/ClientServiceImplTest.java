 ...
 * Client c = new Client("Salhi", "Ahmed", dateNaissance,
 * "ahmed.salhi@esprit.tn", "pwd", Profession.Cadre,
 ...
 * List<Client> clients = clientService.getClientsByDateNaissance(startDate,
 * endDate);
 * log.info(" count" + clients.size());
 * for (Client client : clients) {
 * log.info(" client : " + client.getNom()+
 * " né le "+client.getDateNaissance());
 * 
 * }
 * }
 * 
